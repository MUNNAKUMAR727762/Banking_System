...
public class Database_Connector {
    ...
    private static final String PASSWORD = "MunnaKumar@12";
    ...
    public static Connection connect() throws DatabaseConnectionException {
        ...
        try {
            Class.forName("com.mysql.cj.jdbc.Driver");  // Capital 'C' in 'Class'
            ...
            throw new DatabaseConnectionException("MySQL JDBC Driver not found. Make sure it is included in your project.");
        }
        return connection;
    }
